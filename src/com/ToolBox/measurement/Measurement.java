...
public class Measurement {
    ...
    public Measurement() {
        ...
        area.put("平方千米(km²)", BigDecimal.valueOf(1000000));
        area.put("公顷(ha)", BigDecimal.valueOf(10000));
        area.put("公亩(are)", BigDecimal.valueOf(100));
        area.put("平方米(m²)", BigDecimal.valueOf(1));
        area.put("平方分米(dm²)", BigDecimal.valueOf(0.01));
        area.put("平方厘米(cm²)", BigDecimal.valueOf(0.0001));
        area.put("平方毫米(mm²)", BigDecimal.valueOf(0.000001));
        ...
        volume.put("立方米(m³)", BigDecimal.valueOf(1));
        volume.put("立方厘米(cm³)", BigDecimal.valueOf(0.000001));
        volume.put("立方分米(dm³)", BigDecimal.valueOf(0.001));
        volume.put("立方毫米(mm³)", BigDecimal.valueOf(0.000000001));
